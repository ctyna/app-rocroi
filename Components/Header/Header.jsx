        ...
        <>
            <header className="Header">
                <div className="Header-wrapper">
                    ...
                    <img src="/assets/roc_logo.png" width={1000} height={32} alt="roc roi sitio dónde hay muchas actividades de aventura" title='ROCROI centro actividades' className="Header-logo" loading='eager' />
