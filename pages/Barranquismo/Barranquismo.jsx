...
export const Barranquismo = () =>{
    ...
    const [barranquismo, setBarranquismo] = useState([])

    const {VITE_API} = import.meta.env

    const pedirBarranquismo = async () => {
        ...
        await fetch(`${VITE_API}/actividades/barranquismo`, options)
            .then(res => res.json())
            .then(data => setBarranquismo(data))
        ...
        <>
            ...
            <main className="Activity">
                <div className="Activity-wrapper">
                    {barranquismo.length === 0 && <p>Cargando información</p>}
                    {barranquismo.length !== 0 && barranquismo.map((eachFerrata) =>
